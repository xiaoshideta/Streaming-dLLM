...
class RotaryEmbedding(nn.Module):
    def __init__(
        ...
        # 强制使用 float32 计算 inv_freq 以保证精度
...
class LLaDABlock(nn.Module):
    ...
    def attention(
        ...
        if position_embeddings is None:
            ...
            print("For batched replace_position, use the maximum position across all batches")
        ...
        if self.config.rope:
            ...
            if replace_position is None:
                ...
                q, k = apply_rotary_pos_emb(q, k, cos, sin, max_replace_pos)
